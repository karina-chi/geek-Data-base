...
CREATE TABLE `likes` (
  `from_users_id` int unsigned NOT NULL,
  `to_messages_id` int unsigned DEFAULT NULL,
  `to_posts_id` int unsigned DEFAULT NULL,
  `to_media_id` int unsigned DEFAULT NULL,
  UNIQUE KEY `index` (`from_users_id`,`to_messages_id`),
  UNIQUE KEY `i2` (`from_users_id`,`to_posts_id`) /*!80000 INVISIBLE */,
  UNIQUE KEY `i3` (`to_media_id`,`from_users_id`),
  KEY `fk_likes_users1_idx` (`from_users_id`),
  KEY `fk_likes_messages1_idx` (`to_messages_id`),
  KEY `fk_likes_posts1_idx` (`to_posts_id`),
  KEY `fk_likes_media1_idx` (`to_media_id`),
  CONSTRAINT `fk_likes_media1` FOREIGN KEY (`to_media_id`) REFERENCES `media` (`id`),
  CONSTRAINT `fk_likes_messages1` FOREIGN KEY (`to_messages_id`) REFERENCES `messages` (`id`),
  CONSTRAINT `fk_likes_posts1` FOREIGN KEY (`to_posts_id`) REFERENCES `posts` (`id`),
  CONSTRAINT `fk_likes_users1` FOREIGN KEY (`from_users_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='лайки';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='медиа-файлы';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `media_types` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='типы медиа';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='сообщения';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='посты';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='вспомогательная таблица, пользователи, которые находятся в группе';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-12-03 22:54:08
